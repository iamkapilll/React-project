...
const Courses = () => {
  return (
    <section className="max-w-7xl mx-auto border-b-2" id="Courses">
      <div className="my-20">
        <h2 className="text-xl lg:text-3xl tracking-tight text-center uppercase mb-20">
          Our Featured Courses
        </h2>
        {COURSE_SERVICES.map((course, index) => (
          <div key={index} className="mb-12 mx-4 flex flex-col lg:flex-row">
            ...
            >
              <h3 className="text-xl lg:text-2xl font-medium mb-2">{course.title}</h3>
